...
pacstrap /mnt alacritty base base-devel bluez bluez-utils bspwm efibootmgr feh firefox git grub htop intel-ucode linux linux-firmware linux-headers mpv nautilus neovim net-tools networkmanager ntfs-3g obs-studio openssh papirus-icon-theme picom pipewire pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse polybar pulsemixer rofi sxhkd ttc-iosevka ttf-font-awesome unzip xf86-video-intel xorg-server xorg-xinit xorg-xsetroot &&
