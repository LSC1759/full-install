...
pacstrap /mnt alacritty amd-ucode base base-devel blueman bluez bspwm efibootmgr firefox git grub htop intel-ucode linux linux-firmware linux-headers mpv nano neofetch net-tools networkmanager nitrogen obs-studio openssh papirus-icon-theme pavucontrol picom pipewire pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse polybar rofi sxhkd ttf-font-awesome unzip xorg &&
